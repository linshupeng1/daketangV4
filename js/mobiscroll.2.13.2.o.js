    ...
    var ms = $.mobiscroll,
        ...
        preset = function (inst) {
            ...
            var i,
                ...
                mind= (function(s){
                    if(s.minDate){
                        return typeof s.minDate==='string'?new Date(s.minDate):s.minDate;
                    }
                    return new Date(s.startYear, 0, 1);
                })(s),
                //maxd = s.maxDate || new Date(s.endYear, 11, 31, 23, 59, 59),
                maxd= (function(s){
                    if(s.maxDate){
                        return typeof s.maxDate==='string'?new Date(s.maxDate):s.maxDate;
                    }
                    return new Date(s.endYear, 11, 31, 23, 59, 59);
                })(s),
